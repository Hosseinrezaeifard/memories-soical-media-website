...
import { Avatar, Grid, Button, Container, Typography, Paper } from '@material-ui/core'
        ...
        <Container component='main' maxWidth='xs'>
            <Paper className={classes.paper} elevation={3}>
                ...
                <form className={classes.form} onSubmit={handleSubmit}>
                    ...
                    <GoogleLogin
                        clientId="112747133410-3l0hkg5m2bcrhkd390h1jjiusughofpb.apps.googleusercontent.com"
                        render={(renderProps) => (
